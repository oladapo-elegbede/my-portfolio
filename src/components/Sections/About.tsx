    ...
    <section style={{background: '#fff', padding: isMobile ? '50px 20px' : '70px 40px'}}>
      <div style={{maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '50px', alignItems: 'center'}}>
        ...
        <motion.div initial={{opacity: 0, x: 50}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.8}} viewport={{once: true}} style={{flex: 1}}>
          ...
          <h2 style={{color: '#1a1a1a', fontSize: isMobile ? '1.8rem' : '2.2rem', fontWeight: 'bold', marginBottom: '20px', lineHeight: 1.2}}>A Passionate Full Stack Developer Based in Lagos</h2>
          <p style={{color: '#555', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '16px'}}>I am Oladapo Elegbede, a passionate full stack developer with 4 years of experience building modern web applications. I graduated from Lagos State University and completed advanced Full Stack training at Torilo Academy.</p>
